...
2. Copie y pegue el archivo /files_to_add/Colombia/arroz_coco.html en el directorio /recetas/Colombia de su copia de trabajo local.
3. Copie y pegue la imagen /files_to_add/imagenes/arroz_coco.jpg en la carpeta /imagenes de su copia de trabajo local.
4. Incluya la nueva receta en el archivo index.html.
5. Confirme los cambios en el repositorio local.
